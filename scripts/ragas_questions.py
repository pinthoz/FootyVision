...
PINNABLE: tuple[str, ...] = (
    "Messi", "Ronaldo", "Neymar", "Iniesta", "Griezmann", "Casimiro", "Putellas", "Kroos",
    "Bakambu", "Leno", "Modric", "Hazard", "Benzema", "Bonucci", "Buffon", "Higuain",
    "Perisic", "Vardy", "Payet", "Lacazette", "Bellarabi", "Alessandrini", "Cavani",
    "Verratti", "Marchisio", "Pjanic", "Oyarzabal", "Depay", "Alli", "Ozil", "Firmino",
    "Coutinho", "Mahrez", "Wendell", "Kampl",
)

# Nationalities with fifteen or more players, so a question about one has a real pool.
NATIONS_EN: tuple[str, ...] = (
    "Spanish", "Italian", "French", "English", "German", "Brazilian", "Argentine",
    "Swedish", "Senegalese", "Dutch", "Portuguese", "Serbian", "Belgian", "Scottish",
    "Danish", "Welsh", "Swiss", "Norwegian", "Austrian", "Irish", "Japanese", "Moroccan",
    "Polish", "Uruguayan", "Colombian", "Croatian", "Canadian", "Nigerian", "Chilean",
)
NATIONS_PT: tuple[str, ...] = (
    "espanhois", "italianos", "franceses", "ingleses", "alemaes", "brasileiros",
    "argentinos", "suecos", "senegaleses", "holandeses", "portugueses", "servios",
    "belgas", "escoceses", "dinamarqueses", "noruegueses", "austriacos", "irlandeses",
    "japoneses", "marroquinos", "polacos", "uruguaios", "colombianos", "croatas",
    "canadianos", "nigerianos", "chilenos",
)

ROLES_EN: tuple[str, ...] = (
    "wingers", "centre backs", "full-backs", "wing-backs", "goalkeepers",
    "defensive midfielders", "attacking midfielders", "centre forwards", "strikers",
)
ROLES_PT: tuple[str, ...] = (
    "extremos", "defesas centrais", "laterais", "alas", "guarda-redes",
    "medios defensivos", "medios ofensivos", "pontas de lanca", "avancados",
)

METRICS_EN: tuple[str, ...] = (
    "goals", "assists", "shots", "progressive passes", "dribbles", "carries", "tackles",
    "interceptions", "blocks", "clearances", "ball recoveries", "pressures",
)
METRICS_PT: tuple[str, ...] = (
    "golos", "assistencias", "remates", "passes progressivos", "dribles", "conducoes",
    "desarmes", "intercecoes", "bloqueios", "cortes", "recuperacoes", "pressoes",
)
...
WOMENS: tuple[str, ...] = (
    "Liga F", "the NWSL", "the FA Women's Super League", "the Frauen Bundesliga",
    "Serie A Women",
)

# Nothing in the seventeen per-90 columns measures any of these.
ABSENT_EN: tuple[str, ...] = (
    "aerial duels won", "saves", "yellow cards", "fouls committed", "offsides",
    "distance covered", "sprints", "crosses", "corners taken", "penalties saved",
    "expected assists", "transfer fees",
)
ABSENT_PT: tuple[str, ...] = (
    "duelos aereos ganhos", "defesas do guarda-redes", "cartoes amarelos", "faltas",
    "foras de jogo", "distancia percorrida", "cruzamentos", "cantos",
)
...
ABSENT_PLAYERS: tuple[str, ...] = (
    "Erling Haaland", "Bruno Fernandes", "Jude Bellingham", "Vinicius Junior",
    "Bukayo Saka", "Pedri", "Jamal Musiala", "Rafael Leao", "Ruben Dias", "Joao Felix",
)
